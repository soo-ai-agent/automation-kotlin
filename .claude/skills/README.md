...
| [ponytail-review](ponytail-review/SKILL.md) | diff 에서 오버엔지니어링만 골라내는 리뷰 | 코드 리뷰할 때 함께 — 리뷰어가 연다 |
| [ponytail-audit](ponytail-audit/SKILL.md) | 저장소 전체 오버엔지니어링 감사 | 사람이 부를 때만 — "뭘 덜어낼 수 있어?" |
| [ponytail-debt](ponytail-debt/SKILL.md) | `ponytail:` 주석을 모아 만든 부채 장부 | 사람이 부를 때만 — "미뤄둔 게 뭐야?" |
...
`ponytail` 계열은 해법을 줄이는 스킬이지 규칙을 줄이는 스킬이 아니다 — 리뷰 규칙의 MUST(`rules/code-review.md`)는 ponytail 로도 생략할 수 없다.
