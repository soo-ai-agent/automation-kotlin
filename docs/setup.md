...
| 지도·광고를 쓸 때 | 그때만 키를 채운다 — 지도는 `kakaoJsKey`([map/README](../frontend/src/map/README.md)), 광고는 `admob*`([ads/README](../frontend/src/ads/README.md)·[ads.md](ads.md)). 비워 두면 그 모듈만 안 뜨고 나머지는 정상이다 |
