...
import {NotifyTitle} from "@/constants";
import {requestConfirm, type ConfirmDialogOptions} from "./confirm-dialog";

/**
 * 알림 단일 창구 — 알림 UI 를 바꿀 때 이 파일만 고친다. 컴포넌트·훅·요청 모듈은 이 창구만 부른다.
 *
...
export const notify = {
    ...
    /** 앱 디자인 팝업으로 물어보고 사용자의 선택을 돌려준다. 그리는 것은 루트 레이아웃의 ConfirmDialogHost 다. */
