...
import {AdsMessages} from "@/constants";
import {ADMOB_BANNER_ID} from "@/utils/config";
import {getAdMob} from "@/utils/admob";
import {resolveAdUnitId} from "@/utils/ad-unit";
import type {AdMobModule} from "@/utils/admob-types";
...
export function AdBanner() {
    ...
    // 광고가 실제로 들어왔는지는 SDK 콜백으로만 알 수 있고 밖으로 나가지 않는다 — 자기 표현 상태.
